...
import {
  ...
  ScrollView,
  Image,
  TouchableOpacity, Linking, AppState, View
  ...
  componentDidMount = async () => {
    ...
    await firestore()
      ...
      .then(documentSnapshot => {
        console.log('subject meet exists: ', documentSnapshot.exists);
        if (documentSnapshot.exists) {
          console.log('subject meet data: ', documentSnapshot.data());
          this.setState({ meet: documentSnapshot.data().meet })
    ...
    console.log("meet state", this.state.meet);
    ...
    await firestore()
      ...
      .onSnapshot(querySnapshot => {
        ...
        querySnapshot.forEach(documentSnapshot => {
          if (req == documentSnapshot.data().sub) {
            users.push(
            ...
            <View>
              ...
              >
                <Text
                  style={styles.meet}
                h3>
                  {`Subject :-> ${this.props.route.params.req}`}
                </Text>
              </View>
              <Block flex={false} row center>
                <View
                ...
                >
                  ...
                  <Text
                    style={styles.meet}
                    onPress={() => {
                      Linking.openURL(this.state.meet)
                      console.log("meet link", this.state.meet);
                    }}
                    h1>
                    LIVE SESSION
                  </Text>
